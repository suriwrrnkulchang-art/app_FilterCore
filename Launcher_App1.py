...
URL = "https://raw.githubusercontent.com/suriwrrnkulchang-art/55/main/install.py"

TEMP_FILE = os.path.join(tempfile.gettempdir(), "install.py")

socket.setdefaulttimeout(10)

try:
    print("กำลังดาวน์โหลด App1...")
